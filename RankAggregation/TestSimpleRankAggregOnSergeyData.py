...
def compute_aggregated_matrix(matrixfiles_num, matrixfiles, savematrixfile, saveresultfile):
    ...
    matrices = [pd.read_csv(f, sep=',').T.abs() for f in matrixfiles]
...
matricesdirname = "/home/user/Sirius/sergeysdata"
truematricesdirname = "/home/user/Sirius/gene_network_sirius_2019/Matrices_1"
savematricesdirname = "/home/user/Sirius/sergeysdata/Matrices"
predictedfilename = matricesdirname + "/{0}.csv"
truefilename = truematricesdirname + "/{1}_{0}_true.txt"
savematricesfilename = savematricesdirname + "/{0}_predicted.txt"
datalist = ['exps_10', 'exps_10_2', 'exps_10_bgr', 'exps_50', 'exps_50_2', 'exps_50_bgr', 'exps_100', 'exps_100_2', 'exps_100_bgr', 'genes_200_exps_10_bgr', 'genes_200_exps_20_bgr', 'genes_200_exps_40_bgr', 'genes_400_exps_10_bgr', 'genes_400_exps_80_bgr', 'genes_500_exps_10_bgr', 'genes_500_exps_50_bgr', 'genes_500_exps_100_bgr', 'genes_600_exps_10_bgr', 'genes_700_exps_10_bgr', 'genes_1000_exps_10_bgr']
# algolist = ['ET', 'RF']
algolist = ['']
saveresultsfile = "/home/user/Sirius/sergeysdata/res.txt"
tmpfile = "/home/user/Sirius/sergeysdata/tmp.txt"
...
if __name__ == "__main__":
    ...
    for i, dataname in enumerate(datalist):
        ...
        predicted_df = compute_aggregated_matrix(len(algolist), [predictedfilename.format(dataname)], tmpfile, savematricesfilename.format(dataname))
