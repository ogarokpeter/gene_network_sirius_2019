...
def compute_aggregated_matrix(matrixfiles_num, matrixfiles_dima, matrixfiles_petr, matrixfiles_sergey, saveresultfile):
    ...
    matrices = [pd.read_csv(f, index_col=0, sep=',').T.abs() for f in matrixfiles_dima] + \
               ...
               [pd.read_csv(f, index_col=0, sep='\t').abs() for f in matrixfiles_sergey]
...
algolist_dima = ['ET', 'GB', 'Lasso_0.0000001', 'RF', 'XGB']
...
dataname_sergey = datafolder_sergey + ""

tmpfile = "/home/user/Sirius/gene_network_sirius_2019/RankAggregation/tmp6.txt"
savematricesdirname = "/home/user/Sirius/gene_network_sirius_2019/Matrices_Subsets"
savematricesfilename = savematricesdirname + "/{0}_predicted.txt"
saveresultsfile = "/home/user/Sirius/gene_network_sirius_2019/RankAggregation/res_aggregated.txt"
