...
def reconsrtuct_df(lst, genes):
    ...
    for i, gene in enumerate(gns):
        ...
        for i in range(n_genes):
            ...
            d_gene[i] = n_genes / (i + 1) ** 2
        d_gene /= np.sum(d_gene)
        d[gene] = d_gene
        # print(d)
        # break
...
savematricesdirname = "/home/user/Sirius/gene_network_sirius_2019/Matrices_3"
...
datalist = ['exps_10', 'exps_10_2', 'exps_10_bgr', 'exps_50', 'exps_50_2', 'exps_50_bgr']
algolist = ['clr', 'aracne', 'mrnet', 'mrnetb']

tmpfile = "/home/user/Sirius/gene_network_sirius_2019/RankAggregation/data/tmp2.txt"
